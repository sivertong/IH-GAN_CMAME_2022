...
if __name__ == "__main__":
    ...
    np.save('{}/dvar_synth_2dim.npy'.format(opt_dir), X_synth)
    sio.savemat('{}/dvar_synth_2dim.mat'.format(opt_dir), {'vect':X_synth})
